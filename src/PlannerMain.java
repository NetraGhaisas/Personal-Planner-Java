...
class PlannerMain{
	...
	void createHome(String username){
		...
		JLabel hello = new JLabel("<html><br><br><center><b>Hello "+username+"</b><br>");
	...
	public static void main(String[] args){
		PlannerMain plan = new PlannerMain("user");
	}
}
/*
